...
class Class():
            ...
            for i, j in freePeriods:
                ...
                if teacherTimeTable_[tr][day][period] == '':
                    ...
                    if (subject == 'ARAB'):
                        ...
                        print("\n teacher time table")
                        list(map(print, teacherTimeTable_[teacher]))
                        print(" \n --------------------------------------------------")
                    return True
            return False
    ...
    def initialArrange(self):
        ...
        ct = 0
        for aa in self.periods:
            for bb in aa:
                if bb != '':
                    ct += 1
        print("initial: ", str([self.grade, self.section, ct]))
...
grade = [classes]
class = [[periods]]
period: {subjectName,  subjectTeacher, i, j}
